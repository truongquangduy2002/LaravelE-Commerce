                            ...
                            <form id="myForm" method="post" action="{{ route('update.slider') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slider_title" class="form-control"
                                        value="{{ $sliderData->slider_title }}" placeholder="Slider Title">
                                </div>
                                @error('slider_title')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="short_title" class="form-control"
                                        value="{{ $sliderData->short_title }}" placeholder="Short Title">
                                </div>
                                @error('short_title')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ asset($sliderData->slider_image) }}" alt="Admin"
