                        ...
                        <div class="card-body">
                            <form id="myForm" method="POST" action="{{ route('store.banner') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" name="banner_url" class="form-control"
                                        value="{{ old('banner_url') }}" placeholder="Banner Title">
                                </div>
                                @error('banner_url')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                ...
                                <div class="col">
                                    <button type="submit" class="btn btn-primary px-5">Add Banner</button>
                                </div>
                            </form>
                        </div>
                    </div>
