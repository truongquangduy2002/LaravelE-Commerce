                            ...
                            <form id="myForm" method="POST" action="{{ route('update.brand') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" name="brand_name" class="form-control"
                                        value="{{ $brandData->brand_name }}" placeholder="Slider Title">
                                </div>
                                @error('brand_name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="slug" name="brand_slug" class="form-control"
                                        value="{{ $brandData->brand_slug }}" placeholder="Short Title">
                                </div>
                                @error('brand_slug')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ asset($brandData->brand_image) }}" alt="Admin"
