...
<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('all.sub_category') }}"><i class="bx bx-right-arrow-alt"></i>All SubCategory</a>
                </li>
                <li> <a href="{{ route('add.sub_category') }}"><i class="bx bx-right-arrow-alt"></i>Add SubCategory</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('admin.inactive.vendor') }}"><i class="bx bx-right-arrow-alt"></i>Inactive
                        Vendor</a>
                </li>
                <li> <a href="{{ route('admin.active.vendor') }}"><i class="bx bx-right-arrow-alt"></i>Active
                        Vendor</a>
                </li>
            </ul>
        </li>
        ...
        <ul>
            ...
            <li class="menu-label">Stting & Other</li>
            <li> <a href="{{ route('site.setting') }}"><i class="bx bx-right-arrow-alt"></i>Site Setting</a>
            </li>
            <li> <a href="{{ route('seo.setting') }}"><i class="bx bx-right-arrow-alt"></i>Seo Setting</a>
            </li>
