                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <img src="{{ !empty($users->photo) ? url('upload/vendor_images/' . $users->photo) : url('upload/no_image.jpg') }}"
                                            alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                        <div class="mt-3">
                                            <h4>{{ $users->name }}</h4>
                                            <p class="text-secondary mb-1">{{ $users->email }}</p>
                                            <p class="text-muted font-size-sm">{{ $users->address }}</p>
                                            <p class="text-muted font-size-sm">{{ $users->vendor_short_info }}</p>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <select name="vendor_join" class="form-select mb-3"
                                                    ...
                                                    <option value="2022"
                                                        {{ $users->vendor_join == 2022 ? 'selected' : '' }}>2022
                                                    </option>
                                                    <option value="2023"
                                                        {{ $users->vendor_join == 2023 ? 'selected' : '' }}>2023
                                                    </option>
                                                    <option value="2024"
                                                        {{ $users->vendor_join == 2024 ? 'selected' : '' }}>2024
                                                    </option>
                                                    <option value="2025"
                                                        {{ $users->vendor_join == 2025 ? 'selected' : '' }}>2025
                                                    </option>
                                                    <option value="2026"
                                                        {{ $users->vendor_join == 2026 ? 'selected' : '' }}>2026
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
